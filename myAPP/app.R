              ...
              fluidRow(
                box(title = "Welcome to the Penguin Explorer!", width = 12, status = "primary", solidHeader = TRUE,
                    ...
                    <div style="display: flex; justify-content: center;align-items: flex-end; gap: 20px;">
                      <img src="images/3_pen_2.jpg" style="height: 100px; width: auto; border-radius: 8px;" />
                      <img src="images/alice.jpg" style="height: 200px; width: auto; border-radius: 8px;" />
                      <img src="images/3_pen_1.jpg" style="height: 100px; width: auto; border-radius: 8px;" />
                    </div>
                  ')
                )
              )
